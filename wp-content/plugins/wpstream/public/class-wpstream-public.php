...
class Wpstream_Public {
	...
	public function enqueue_scripts() {
                ...
                wp_enqueue_script('video.min',              'https://vjs.zencdn.net/8.3.0/video.min.js', WPSTREAM_PLUGIN_VERSION, true);
                ...
                array( 
                    'we_are_not_live'             =>    esc_html( get_option('wpstream_you_are_not_live','We are not live at this moment. Please check back later.')),
                ));
