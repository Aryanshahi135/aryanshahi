...
<div style="text-align: center;font-weight: 600;font-size: 26px;padding: 10px 0;border-bottom: solid 3px #eeeeee">{Fun Olympc}</div>
...
<div>Thank you!</div>
<div>The <a style="color: #3ba1da;text-decoration: none" href="http://localhost/olympic/">{Fun Olympic}</a> Team</div>
</div>
</div>