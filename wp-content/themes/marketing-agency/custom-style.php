<?php
	...
	$marketing_agency_button_letter_spacing = get_theme_mod('marketing_agency_button_letter_spacing',14);
	$marketing_agency_custom_css .='.post-main-box .more-btn a{';
	...
	if($marketing_agency_footer_background_image != false){
		$marketing_agency_custom_css .='#footer{';
			$marketing_agency_custom_css .='background: url('.esc_attr($marketing_agency_footer_background_image).');';
		$marketing_agency_custom_css .='}';
	}
	...
	if($marketing_agency_site_title_color != false){
		$marketing_agency_custom_css .='p.site-title a{';
			$marketing_agency_custom_css .='color: '.esc_attr($marketing_agency_site_title_color).'!important;';
		$marketing_agency_custom_css .='}';
	}
